...
NUTRITION_PARTNERS = {
    ...
    "Chop Stop",
    "Sizzling Pot House",
    "Shan Indian and Pakistani Restaurant",
    "Lotus & Lime",
    "Green Bulgogi",
    "K BBQ Pocha",
    "House Of Falafel",
    ...
    "Pasta Pomodoro",
    "Bona Pizza",
    "Little Seven Special Soup with Rice",
    "Mia's Bento Snacks & Tea",
    ...
    "A2B Indian Vegetarian",
    "Zuzubowls",
    "XENiA Mediterranean Kitchen",
    "El Pollo Loco",
